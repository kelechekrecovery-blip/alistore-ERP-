...
ARG NEXT_PUBLIC_AUTH_REFRESH_ROTATION_GRACE_ENABLED=false
ARG NEXT_PUBLIC_AUTH_EMAIL_LOGIN_ENABLED=false
ENV NEXT_PUBLIC_API_BASE=$NEXT_PUBLIC_API_BASE
ENV NEXT_PUBLIC_DEMO_MODE=$NEXT_PUBLIC_DEMO_MODE
ENV NEXT_PUBLIC_SITE_URL=$NEXT_PUBLIC_SITE_URL
ENV NEXT_PUBLIC_AUTH_REFRESH_ROTATION_GRACE_ENABLED=$NEXT_PUBLIC_AUTH_REFRESH_ROTATION_GRACE_ENABLED
ENV NEXT_PUBLIC_AUTH_EMAIL_LOGIN_ENABLED=$NEXT_PUBLIC_AUTH_EMAIL_LOGIN_ENABLED
