...
## Next
- `MKT-003` Replace the hard-coded checkout promo with owner/marketer-managed promotion codes: draft/active/paused/expired lifecycle, date window, total/per-customer limits, product/category/minimum-total rules, canonical server quote/application, RBAC, Ledger, ERP Marketing CMS and checkout consequence E2E.
