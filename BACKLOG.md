...
## Next
- `MKT-004` Replace the fixed storefront composition with owner/marketer-managed banner and content-block entities: explicit type/order/device targeting, draft/scheduled/published/archived lifecycle, asset validation, non-overlapping schedules, RBAC, Ledger and ERP-to-storefront visual consequence E2E.
