...
- Extend the exact `alistore-shop.html` desktop visual system into the custom account devices, order detail/status and device-warranty screens; keep the separate staff warranty console on its ERP handoff.
