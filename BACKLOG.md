...
- Close remaining native Android feature parity in vertical flows: final Client provider/device smoke; Staff physical FCM/scanner/camera certification; Courier Evidence/push/physical maps-camera certification; POS scanner/IMEI, explicit shift UI, queued-approval recovery, receipt printing, refund/exchange and physical terminal certification.
