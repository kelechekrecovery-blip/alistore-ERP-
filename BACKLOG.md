...
- Close remaining native iOS feature parity in vertical flows: Client final provider/device smoke; POS ticket/split payment/approval/offline replay; then certify Staff/Courier APNs, maps, scanner and camera behavior on physical iPhones.
