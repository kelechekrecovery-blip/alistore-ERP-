...
const KIND_META: Record<string, { label: string; icon: string; area: string }> = {
  ...
  repeat_returns: { label: 'Повторные возвраты', icon: '↩', area: 'Fraud' },
  discount_frequency: { label: 'Много скидок', icon: '🏷', area: 'Маржа' },
  write_off_spike: { label: 'Рост списаний', icon: '🗑', area: 'Склад' },
