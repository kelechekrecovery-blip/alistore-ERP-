...
export function ScrollProgress() {
  return <div aria-hidden className="store-scroll-progress absolute inset-x-0 bottom-0 h-[2px] origin-left bg-gradient-to-r from-[#fb9a4b] via-[#f97316] to-[#7ee2a0]" />;
}
