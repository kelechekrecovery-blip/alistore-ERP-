...
export default function AccountPage() {
  ...
  if (!hydrated || !user) return <div className="min-h-screen bg-[#0b0a08] text-white/48"><SiteHeader variant="design3" /><div className="grid min-h-[70vh] place-items-center">Загрузка кабинета...</div></div>;
