...
const CHECKS: CheckDefinition[] = [
  ...
  },
  {
    ...
    requiredAny: [['NOVU_API_KEY'], ['SMTP_HOST']],
    optionalEnv: ['NOVU_API_URL', 'SMTP_PORT', 'SMTP_USER', 'SMTP_FROM'],
    blocking: true,
    note: 'Segment Builder and ROI are ready; external delivery needs Novu or SMTP.',
  },
  {
    id: 'pos_hardware',
    area: 'hardware',
