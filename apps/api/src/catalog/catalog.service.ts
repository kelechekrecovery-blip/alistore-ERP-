...
export class CatalogService {
   ...
   *
   * Рассрочка — по договорным условиям владельца. Бонус здесь предварительный:
   * окончательное начисление считается от итога заказа после скидок, списания
   * бонусов и доставки. Поэтому клиенты обязаны помечать эту цифру как оценку.
   */
