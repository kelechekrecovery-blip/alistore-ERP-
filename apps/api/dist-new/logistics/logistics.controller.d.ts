...
export declare class LogisticsPublicController {
    private readonly logistics;
    constructor(logistics: LogisticsService);
    availability(query: LogisticsDateQueryDto): Promise<{
        slots: {
            reserved: number;
            remaining: number;
            available: boolean;
    ...
    checkoutOptions(query: LogisticsDateQueryDto): Promise<{
        pickupPoints: {
            id: string;
            name: string;
            code: string;
...
export declare class LogisticsController {
    private readonly logistics;
    constructor(logistics: LogisticsService);
    overview(query: LogisticsDateQueryDto): Promise<{
        zones: {
            slots: {
                reserved: number;
                remaining: number;
    ...
    createZone(user: AuthPrincipal, key: string | undefined, dto: CreateDeliveryZoneDto): Promise<{
        id: string;
        name: string;
        code: string;
        idempotencyKey: string;
    ...
    createSlot(user: AuthPrincipal, key: string | undefined, dto: CreateDeliverySlotDto): Promise<{
        id: string;
        idempotencyKey: string;
        createdBy: string;
        createdAt: Date;
    ...
    createStorePoint(user: AuthPrincipal, key: string | undefined, dto: CreateStorePointDto): Promise<{
        id: string;
        name: string;
        code: string;
        idempotencyKey: string;
    ...
    updateStorePoint(user: AuthPrincipal, id: string, key: string | undefined, dto: UpdateStorePointDto): Promise<import("@prisma/client/runtime/library").InputJsonValue | null>;
}
