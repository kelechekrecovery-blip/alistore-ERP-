...
var ReservationsScheduler_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReservationsScheduler = void 0;
...
let ReservationsScheduler = ReservationsScheduler_1 = class ReservationsScheduler {
    constructor(config, reservations, exchanges, alerter) {
        this.config = config;
        this.reservations = reservations;
        this.exchanges = exchanges;
        this.alerter = alerter;
        this.logger = new common_1.Logger(ReservationsScheduler_1.name);
    }
    async onModuleInit() {
        if (this.config.get('PROCESS_ROLE') === 'worker')
            return;
        if (this.config.get('RESERVATION_SWEEP_ENABLED') !== 'true') {
            this.logger.log('Reservation sweep disabled (set RESERVATION_SWEEP_ENABLED=true to enable)');
            return;
        }
        ...
        try {
            ...
            await this.boss.work(QUEUE, async () => {
                try {
                    ...
                    this.logger.error('Reservation sweep tick failed', err);
            ...
            this.boss = undefined;
            this.logger.error('Failed to start reservation sweep', err);
...
exports.ReservationsScheduler = ReservationsScheduler;
exports.ReservationsScheduler = ReservationsScheduler = ReservationsScheduler_1 = __decorate([
...
//# sourceMappingURL=reservations.scheduler.js.map