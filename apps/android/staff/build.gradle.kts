...
require(!releaseRequested || firebaseConfigured) { "Staff Release requires apps/android/staff/google-services.json" }
android {
  namespace = "kg.alistore.staff"
  compileSdk = 36
  defaultConfig {
    applicationId = "kg.alistore.staff"; minSdk = 26; targetSdk = 36
