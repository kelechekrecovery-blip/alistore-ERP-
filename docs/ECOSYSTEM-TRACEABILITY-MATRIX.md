...
| Service center | `/erp`, `/pos`, `/account/devices` | warranty and paid intake, technician, diagnosis, estimate approval, open-shift split settlement/refund provenance, RBAC, replay, Ledger | concurrent API tests + 2 browser journeys | Partial: parts, execution/SLA, loaner custody and 30-day warranty |
