...
| Service center | `/erp`, `/account/devices` | warranty and paid intake, technician, diagnosis, estimate approval, RBAC, replay, Ledger | 3 API tests + 2 browser journeys | Partial: POS payment, parts, execution/SLA, loaner custody and 30-day warranty |
