...
| Marketing CMS | `/erp`, storefront | revisioned content, ordered product collection, non-overlapping schedules, campaign/consent/channel primitives | API 5/5 + ERP-to-storefront Playwright | Partial: collection draft/publish/schedule/cancel and storefront consequence complete; banner/block ordering, review approval and promo/review moderation remain |
