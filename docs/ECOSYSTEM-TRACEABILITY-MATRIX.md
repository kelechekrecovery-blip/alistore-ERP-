...
| Marketing CMS | `/erp`, storefront, checkout | revisioned content; ordered hero/promo/info/collection blocks; device targeting; approved-only reviews; managed promotions; consent-filtered campaign recipients; server tracking codes; first/last UTM; hashed click/visit/checkout/conversion funnel; payment-bound conversion; replay-safe refund compensation; paid and net revenue/gross/ROAS | content/block/review/promotion/campaign API + RBAC/Ledger + campaign-to-desktop/mobile/checkout/payment/refund/ERP Playwright | Accepted for committed Marketing CMS, privacy-safe funnel and net economics; production media/channel certification, advertiser lifecycle and provider spend import remain |
