...
1. Native parity wave: Client final provider/device smoke; Staff physical APNs/FCM/scanner/camera certification; Courier iOS parity plus Android live-push/device certification;
