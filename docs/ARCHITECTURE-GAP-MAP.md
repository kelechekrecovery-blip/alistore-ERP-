...
| Staff | Native target builds; staff login, role shell and live shift lifecycle with current/open/detail/drawer reconciliation/close through staff JWT and RBAC | Separate Compose APK builds with role shell and shared secure/offline core | order/task queues, Customer 360, scanner, warranty/support, shift evidence and push |
