...
|---|---|---|---|
| Next.js storefront + ERP/admin | 39 routes, production build and 41 verified Playwright flows | Ready | `npm run build -w @alistore/web`, broad Playwright plus targeted Marketing CMS acceptance |
| NestJS modular monolith | 52 modules including Storefront CMS and Promotions behind one API | Ready | API build and 125 Jest suites |
| PostgreSQL + Prisma | 64 migrations, transactional domain services | Ready | isolated test DB reset + migration deploy |
