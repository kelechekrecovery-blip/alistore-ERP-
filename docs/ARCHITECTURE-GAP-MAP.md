...
| Staff | Native target builds; staff login; live order fulfillment queue; Customer 360 with role-masked PII, purchases, debt, warranty and support aggregates; guarded warranty SLA progression; live reconciled shift lifecycle through staff JWT and RBAC | Separate Compose APK builds with role shell and shared secure/offline core | scanner, Evidence Vault, full support actions, general tasks and push |
