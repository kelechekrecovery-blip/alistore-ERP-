...
- All four Debug APKs build; unit tests, Android Lint and Client Compose auth/checkout tests pass.
  Client OTP/login, process-restart session restore and cart/checkout UI are verified on Android API 36.

## Execution order

1. Native parity wave: Client payment/orders/account; Staff operations; Courier delivery/COD;
