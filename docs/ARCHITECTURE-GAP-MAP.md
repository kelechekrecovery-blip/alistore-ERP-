...
|---|---|---|---|
| Next.js storefront + ERP/admin | 39 routes, production build and 40 verified Playwright flows | Ready | `npm run build -w @alistore/web`, broad Playwright plus targeted Marketing CMS acceptance |
| NestJS modular monolith | 51 modules including Storefront CMS behind one API | Ready | API build and 124 Jest suites |
| PostgreSQL + Prisma | 63 migrations, transactional domain services | Ready | isolated test DB reset + migration deploy |
