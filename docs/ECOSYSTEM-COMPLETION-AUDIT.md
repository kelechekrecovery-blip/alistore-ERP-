...
| Marketing CMS | Partial | ordered product collections, immediate/scheduled publication, cancellation, approved-only review moderation, RBAC/Ledger and storefront consequence E2E; campaigns, consent and channel transports | managed promo-code lifecycle and banner/block ordering |
