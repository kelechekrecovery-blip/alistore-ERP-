...
| Marketing CMS | Partial | ordered product collections, immediate/scheduled publication, cancellation, approved-only review moderation, managed promotion limits/redemptions, RBAC/Ledger and storefront/checkout consequence E2E; campaigns, consent and channel transports | banner/block entity ordering and visual publication workflow |
