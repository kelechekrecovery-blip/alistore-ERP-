...
| Marketing CMS | Implemented | revisioned copy plus ordered hero/promo/info/collection blocks, desktop/mobile targeting, immediate/scheduled publication, approved-only review moderation, managed promotion limits/redemptions, RBAC/Ledger and storefront/checkout consequence E2E | production media population, live channel certification and campaign attribution/ROAS sit outside the committed CMS screen acceptance |
