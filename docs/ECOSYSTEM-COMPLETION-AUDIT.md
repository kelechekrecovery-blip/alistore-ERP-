...
| Client App 2.0 | Partial | SwiftUI/Compose shells and major customer API flows; iOS Keychain and Android Keystore quick unlock with biometric capability checks and throttled PIN | screen-by-screen pixel matrix, deeper signed-in XCUITest/Compose E2E, physical biometric/push/device gate |
