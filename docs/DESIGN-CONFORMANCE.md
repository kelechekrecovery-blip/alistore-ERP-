...
|---|---|---|---|
| Desktop storefront | `alistore-shop.html` | Light gray/white + Ink + coral accent | Home, header, catalog, product, cart and checkout aligned; search/favorites/compare/login/account pending |
