...
- **111 API test suites / 435 тестов — зелёные** (`jest`)
...
Finance 2.0 cashflow/инкассация/валюта · наборы/предзаказы (варианты SKU готовы) · quantity/consignment warehouse · HR-графики ·
...
cd apps/api && npx jest                 # 111 suites / 435 тестов ✓
npm run api:build                     # ✓
