...
- **99 API test suites / 359 тестов — зелёные** (`jest`)
...
Finance 2.0 · варианты/наборы/предзаказы · quantity/consignment warehouse · HR-графики ·
...
cd apps/api && npx jest --runInBand    # 99 suites / 359 тестов ✓
npm run api:build                     # ✓
