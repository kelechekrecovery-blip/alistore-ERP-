...
- **106 API test suites / 392 теста — зелёные** (`jest --runInBand`)
- **20 Playwright smoke-flow — зелёные**, включая Purchase Order, Finance expense lifecycle и exact desktop purchase vertical (`npm run e2e`)
