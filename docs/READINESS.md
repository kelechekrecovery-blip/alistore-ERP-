...
- Текущий полный gate (`npm run api:test`, снято 2026-07-23 на тихом дереве):
  **202 сьюта / 979 тестов**, из них **4 сьюта / 7 тестов красные**. Повторный прогон
  при работающем рядом втором агенте дал 20+ красных — подтвердить те 7 можно только
  на изолированной БД (`VERIFY-078`). Прежние цифры в этом файле (143/143 и 123/487)
