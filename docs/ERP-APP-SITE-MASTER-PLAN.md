...
quantity consignment plus consignment return reversal and quantity transfer/return, HR schedules/tasks/KPI/payroll, delivery zones/slots,
...
2. Complete quantity consignment, consignment return reversal, quantity transfer/return, serialized bundle return/restock, HR and logistics.
