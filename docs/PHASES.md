...
макс 4, ⇄-переключатель на карточке товара, бейдж «ЛУЧШАЯ ЦЕНА»); ещё: «Мои устройства» ✅ +
гарантийный талон (карточка) в кабинете, статус-заказа timeline как отдельный экран.
