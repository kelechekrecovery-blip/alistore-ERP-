...
не-2xx); полная сборка `AliStoreClient` с интеграцией зелёная; core-сьют 117/117 (было
114); существующие пути checkout не тронуты — вся ветка под `paymentMethod == "gift_card"`.
